...
void Load_GL_VERSION_4_1()
{
	...
	GL_EXT_PROC(PFNGLPROGRAMUNIFORM1IPROC, glProgramUniform1i);
	GL_EXT_PROC(PFNGLPROGRAMUNIFORM1FPROC, glProgramUniform1f);
	GL_EXT_PROC(PFNGLPROGRAMUNIFORM3FPROC, glProgramUniform3f);
}
...
HGLRC GL::CreateGLContext(HWND hwnd)
{
    GL::LoadGLExtension();
	...
	if (GL_KHR_debug) {
		...
		glDebugMessageCallback(GL::glDebugCallback, nullptr);
